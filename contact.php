                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>SEND MESSAGE</h5>
                            <form action="enregistementContact.php" method="post" enctype="multipart/form-data">
                                <input type="text" placeholder="nom" id="nom" name="nom">
                                <input type="text" placeholder="email or phone" id="email" name="email">
                                
                                <textarea placeholder="Message" id="message" name="message" ></textarea>
                                <button type="submit" class="site-btn" onclick="verifier()">Send Message</button>
                            </form>
                        </div>
                    </div>
                </div>
              ...
              if(nom=='' || email=='' || message=='')
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__map">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1639.1366356658395!2d10.74393472742512!3d34.748708396612834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1301d32feb7f77cb%3A0xd62a19f945008594!2sEcole%20Chakroun!5e0!3m2!1sfr!2stn!4v1687098585056!5m2!1sfr!2stn" width="450" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
